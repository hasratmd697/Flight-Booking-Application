...
function flight_search() {
    ...
    if(document.querySelector("#one-way").checked) {
        ...
        const departDate = new Date(document.querySelector("#depart_date").value);
        if(departDate < today) {
    ...
    if(document.querySelector("#round-trip").checked) {
        ...
        const returnDate = new Date(document.querySelector("#return_date").value);
        ...
        if(returnDate < today) {
            alert("Return date cannot be in the past. Please select a valid date.");
            return false;
        }
    }
    return true;
